...
define('SECRET_SALT','X6oPnarg1gaSrz4uD2EDn0qRFK9mf481');

#Default admin email. Used only on db connection issues and related alerts.
define('ADMIN_EMAIL','harsh.chhabra265@gmail.com');
...
define('DBNAME','ostticket');
// define('DBNAME','ost.internal.aii');
define('DBUSER','root');
define('DBPASS','Harsh@123');

# Table prefix
// define('TABLE_PREFIX','beta_internal_os_');
